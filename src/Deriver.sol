...
library Deriver {
   ...
   function getCombinedPubkey(uint256 p1x, uint256 p1y, uint256 p2x, uint256 p2y, uint256 c1, uint256 c2) public pure returns (uint256, uint256) {
    (uint256 x1, uint256 y1) = mulPubkey(p1x, p1y, c1);
    (uint256 x2, uint256 y2) = mulPubkey(p2x, p2y, c2);
        return addPubkeys(x1, y1, x2, y2);
   }

   function getPubkeyFromAddress(uint256 p1x, uint256 p1y, uint256 p2x, uint256 p2y, address addr) public pure returns (uint256, uint256) {
   ...
   function getBtcAddressFromEth(uint256 p1x, uint256 p1y, uint256 p2x, uint256 p2y, bytes memory hrp, address ethAddr) public pure returns (string memory) {
        (uint256 x, uint256 y) = getPubkeyFromAddress(p1x, p1y, p2x, p2y, ethAddr);
